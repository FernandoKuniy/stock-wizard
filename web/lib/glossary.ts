...
export const GLOSSARY = {
  ...
  "market order":
    "Buy or sell right now, at whatever the price currently is. The simplest kind of order: it happens straight away, but you take whatever price the market is at.",

  "limit order":
    "You name your price and wait. A limit buy only goes through if the price drops to your number; a limit sell only if it rises to it. You never pay more than you meant to, but it might never happen at all.",
